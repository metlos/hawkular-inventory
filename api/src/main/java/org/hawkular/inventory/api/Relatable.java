...
/**
 * Base interface for all Inventory interfaces that support adding relationships to entities.
 *
 * @param <Access> the access interface to the relationships. This is either
